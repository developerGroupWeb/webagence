...
if ( !function_exists('dilaz_mb_var') ) {
	function dilaz_mb_var($var) {
		...
		switch ($var) {
			...
			case 'yes_no_bool': 
				$output = array( 1 => __('Yes', 'futurio-extra'), 0 => __('No', 'futurio-extra') ); 
				break;
				
			case 'yes_no': 
				$output = array( 'yes' => __('Yes', 'futurio-extra'), 'no' => __('No', 'futurio-extra') );
				break;
				
			case 'def_yes_no': 
				$output = array( 'default' => __('Default', 'futurio-extra'), 'yes' => __('Yes', 'futurio-extra'), 'no' => __('No', 'futurio-extra') );
				break;
				
			case 'on_off': 
				$output = array( 'on' => __('On', 'futurio-extra'), 'off' => __('Off', 'futurio-extra') );
				break;
				
			case 'true_false': 
				$output = array( 'true' => __('True', 'futurio-extra'), 'false'	=> __('False', 'futurio-extra') );
				break;
			...
			case 'bg_repeat': 
				$output = array( 
					...
					'repeat-x'  => __('Repeat Horizontally', 'futurio-extra'),
					'repeat-y'  => __('Repeat Vertically', 'futurio-extra') 
				);
				break;
				
			case 'body_pos': 
				$output = array( 
					'top left'		=> __('Top Left', 'futurio-extra'),
					'top center'	=> __('Top Center', 'futurio-extra'),
					'top right'		=> __('Top Right', 'futurio-extra'),
					'center left '	=> __('Center Left', 'futurio-extra'),
					'center center'	=> __('Center Center', 'futurio-extra'),
					'center right'	=> __('Center Right', 'futurio-extra'),
					'bottom left'	=> __('Bottom Left', 'futurio-extra'),
					'bottom center'	=> __('Bottom Center', 'futurio-extra'),
					'bottom right'	=> __('Bottom Right', 'futurio-extra') 
				);
				break;
