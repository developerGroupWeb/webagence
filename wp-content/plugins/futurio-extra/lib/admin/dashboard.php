...
class Futurio_Extra_Dashboard {
    ...
    function pro_modules_box(){
        ...
        $modules = array(
            array(
                'name' => __( 'Header Transparent', 'futurio-extra' ),
                'desc' => __( 'Make your website stand out with transparent header modules.', 'futurio-extra' ),
                'url' => 'https://futuriowp.com/help/documentation/futurio-pro-modules/header-transparent/',
            ),
            array(
                'name' => __( 'Header Sticky', 'futurio-extra' ),
                'desc' => __( 'Let your header accessible when users scroll up or down in unique style.', 'futurio-extra' ),
                'url' => 'https://futuriowp.com/help/documentation/futurio-pro-modules/header-sticky/',
            ),
            array(
                'name' => __( 'Header and Footer Builder Booster', 'futurio-extra' ),
                'desc' => __( 'Get more header and footer builder items, plus advanced styling options.', 'futurio-extra' ),
                'url' => 'https://futuriowp.com/help/documentation/futurio-pro-modules/advanced-header-footer-builder/',
            ),
            array(
                ...
                'url' => 'https://futuriowp.com/help/documentation/futurio-pro-modules/scroll-to-top/',
            ),
            array(
                'name' => __( 'Blog Pro', 'futurio-extra' ),
                'desc' => __( 'Take advantage of the Blog Pro module to show off your posts in any layouts.', 'futurio-extra' ),
                'url' => 'https://futuriowp.com/help/documentation/futurio-pro-modules/blog-pro/',
            ),
            array(
                'name' => __( 'Advanced Styling', 'futurio-extra' ),
                'desc' => __( 'Control the layout and typography setting for page header title, page header cover and more.', 'futurio-extra' ),
                'url' => 'https://futuriowp.com/help/documentation/futurio-pro-modules/advanced-styling/',
            ),
//            array(
//                'name' => __( 'WooCommerce Booster', 'futurio-extra' ),
//                'url' => 'https://futuriowp.com/help/documentation/futurio-pro-modules/woocommerce-booster/',
//            ),
            array(
                'name' => __( 'Portfolio', 'futurio-extra' ),
                'desc' => __( 'Show off your best project in a beautiful way.', 'futurio-extra' ),
                'url' => 'https://futuriowp.com/help/documentation/futurio-pro-modules/portfolio/',
            ),
            array(
                'name' => __( 'Multiple Headers', 'futurio-extra' ),
                'desc' => __( 'Create unique header for each page, post, archive or WooCommerce pages.', 'futurio-extra' ),
                'url' => 'https://futuriowp.com/help/documentation/futurio-pro-modules/multiple-headers/',
            ),
            array(
                'name' => __( 'Mega Menu', 'futurio-extra' ),
                'desc' => __( 'Create mega menu for your sites that need more space for navigation.', 'futurio-extra' ),
                'url' => 'https://futuriowp.com/help/documentation/futurio-pro-modules/mega-menu/',
            ),
	        array(
		        'name' => __( 'Multilingual Integration', 'futurio-extra' ),
		        'desc' => __( 'WPML multilingual plugin support, plus a fully customized language switcher header builder item.', 'futurio-extra' ),
                'url'  => ''
	        ),
	        array(
		        'name' => __( 'Custom Fonts', 'futurio-extra' ),
		        'desc' => __( 'Custom Fonts module allows you to add your self-hosted fonts and use them on your Futurio powered websites.', 'futurio-extra' ),
		        'url'  => ''
	        ),

            array(
		        'name' => __( 'Typekit', 'futurio-extra' ),
		        'desc' => __( 'Typekit module allows you to add Typekit fonts and use them on your Futurio powered websites.', 'futurio-extra' ),
		        'url'  => ''
	        ),
	        array(
		        'name' => __( 'Futurio Hooks', 'futurio-extra' ),
		        'desc' => __( 'Add custom hook scripts.', 'futurio-extra' ),
		        'url'  => ''
	        ),
	        ...
	        array(
                ...
                array(
                    'name' => __( 'Single Product Layouts', 'futurio-extra' ),
                    'desc' => __( 'More beautiful layouts for your single product.', 'futurio-extra' ),
                    'url'  => '',
                    'sub' => true,
                ),
                array(
                    'name' => __( 'Off Canvas Filter', 'futurio-extra' ),
                    'desc' => __( 'Add off canvas products filter for shop and product archive pages.', 'futurio-extra' ),
                    'url'  => '',
                    'sub' => true,
                ),
                array(
                    'name' => __( 'Product Gallery Slider', 'futurio-extra' ),
                    'desc' => __( 'Add slider for product gallery.', 'futurio-extra' ),
                    'url'  => '',
                    'sub' => true,
                ),
                array(
                    'name' => __( 'Quick View', 'futurio-extra' ),
                    'desc' => __( 'Add product quick view modal for product listing..', 'futurio-extra' ),
                    'url'  => '',
                    'sub' => true,
                ),

            array(
		        'name' => __( 'Infinity Scroll.', 'futurio-extra' ),
		        'desc' => __( 'Loads the next posts, products automatically when the reader approaches the bottom of the page.', 'futurio-extra' ),
		        'url'  => ''
	        ),
        ...
        ?>
        <div class="cd-box">
            <div class="cd-box-top"><?php _e( 'Futurio Pro Modules', 'futurio-extra' ); ?>
                <a class="cd-upgrade" target="_blank" href="https://futuriowp.com/pricing/?utm_source=theme_dashboard&utm_medium=links&utm_campaign=pro_modules"><?php _e( 'Upgrade Now &rarr;', 'futurio-extra' ); ?></a></div>
