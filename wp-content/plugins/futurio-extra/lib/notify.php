    ...
    <div class="futurio-review-notice">
        ...
        <div class="futurio-review-text">
            ...
            <ul class="futurio-review-ul">
                ...
                <li>
                    <a href="https://futuriowp.com/contact/" target="_blank">
...
function futurio_pro_notice(){
    ...
    $daysinseconds = 1814400; // 21 Days in seconds (1814400).
...
function futurio_pro_notice_message(){
    ...
    <div class="futurio-review-notice">
        ...
        <div class="futurio-review-text">
            ...
            <p><?php _e( 'Get the  <a href="https://futurio.com/futurio-pro/" target="_blank">Pro version</a> for more stunning elements and customization options.', 'futurio-extra' ) ?></p>
            <ul class="futurio-review-ul">
                <li>
                    <a href="https://futurio.com/futurio-pro/" target="_blank">
                        <span class="dashicons dashicons-external"></span>
...
function futurio_pro_dismiss() {
    ...
    update_site_option( 'futurio_active_pro_time', time() );
