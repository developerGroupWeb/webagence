	...
	class FuturioWP_Demos {
      ...
      // Reset theme mods
	    ...
	    public static function popup() {
	       ...
	       if ( ( 'themes.php' == $pagenow && 'futurio-panel-install-demos' == $_GET['page'] ) ) { 
              ?>
				...
				if ( ! is_wp_error( $api ) ) { // confirm error free
					...
					<div class="fwp-plugin fwp-clr fwp-plugin-<?php echo $api['slug']; ?>" data-slug="<?php echo $api['slug']; ?>" data-init="<?php echo $api['init']; ?>">
						...
						if ( 'premium' == $return
							...
							<a class="button" href="https://futuriowp.com/extension/<?php echo $api['slug']; ?>/" target="_blank"><?php esc_html_e( 'Get This Addon', 'futurio-extra' ); ?></a>
						<?php
						} else { ?>
