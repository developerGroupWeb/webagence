...
class Futurio_Customizer_Notice {
	...
	public function scripts_for_customizer() {
		...
		wp_enqueue_style( 'futurio-customizer-notice', get_template_directory_uri() . '/lib/customizer-plugin-recommend/customizer-notice/css/customizer-notice.css', array() );
		...
		wp_enqueue_script( 'futurio-customizer-notice', get_template_directory_uri() . '/lib/customizer-plugin-recommend/customizer-notice/js/customizer-notice.js', array( 'customize-controls' ) );
		wp_localize_script(
			'futurio-customizer-notice', 'customizer_notice_data', array(
				'ajaxurl'                  => admin_url( 'admin-ajax.php' ),
				'template_directory'       => get_template_directory_uri(),
				'base_path'                => admin_url(),
				'activating_string'        => __( 'Activating', 'futurio' ),
			)
		);
